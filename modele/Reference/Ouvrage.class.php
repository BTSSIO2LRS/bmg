...
class Ouvrage {
    ...
    public function __construct($p_no_ouvrage, $p_titre, $p_salle, $p_rayon, $p_obj_genre, $p_date_acquisition) {
    ...
    public function getAuteurs() {
        ...
        foreach ($tab as $ligne) {
            ...
            $lAuteur = new Auteur($ligne->id_auteur, $unAuteur[0]->nom_auteur, $unAuteur[0]->prenom_auteur, $unAuteur[0]->alias, $unAuteur[0]->notes);
     ...
     */
    public function affichAuteursThisOuvrage($nivDetail,$multipleLigne) {
        return AdminRender::affichAuteurs($this->getAuteurs(), $nivDetail, $multipleLigne);
    }
